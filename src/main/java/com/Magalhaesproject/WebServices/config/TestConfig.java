package com.Magalhaesproject.WebServices.config;
...
import com.Magalhaesproject.WebServices.entities.Payment;
import com.Magalhaesproject.WebServices.entities.Product;
import com.Magalhaesproject.WebServices.entities.User;
import com.Magalhaesproject.WebServices.entities.enums.OrderStatus;
import com.Magalhaesproject.WebServices.repositories.CategoryRepository;
import com.Magalhaesproject.WebServices.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2025-03-10T19:53:07Z"),OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2025-03-11T03:42:10Z"),OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2025-03-12T15:21:22Z"),OrderStatus.WAITING_PAYMENT, u1);
		...
		Payment pay1 = new Payment(null, Instant.parse("2025-03-10T19:53:07Z"), o1);
		o1.setPayment(pay1);
